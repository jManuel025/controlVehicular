<?php
    ...
    require('fpdf.php');
    $con = Conectar();
    $sql = "SELECT idLicencia, nombre, fNacimiento, fExpedicion, fVencimiento, tipo, firma, direccion, restriccion, tSangre, donador, tEmergencia
    ...
    $pdf->AddPage('P', 'A5');
    // FRONTAL-------------------------------
    $pdf->Image('mapaqro.png', 47, 76.5, 10);
    $pdf->Image('escudoqro.png', 12, 12, 10 );
    ...
    $pdf->Image('persona.jpg', 39, 24, 22);
    $pdf->SetFontSize(5);
    $pdf->SetXY(22, 40);
    ...
    $pdf->Image('firma.png', 31.5, 76.6, 12.5);
    $pdf->SetXY(12,78.6);
    $pdf->SetFont('Arial','',4);
    ...
    // POSTERIOR --------------------------
    $pdf->Image('911.jpg', 86, 12, 10);
    $pdf->Image('089.jpg', 126, 12, 9.5);
    ...
    $pdf->Image('car1.png', 88, 32, 10);
    $pdf->Image('car2.png', 99.5, 32, 10);
    $pdf->Image('car3.png', 111, 32, 10);
    $pdf->Image('car1.png', 122.5, 32, 10);
    ...
    $pdf->Image('firma2.png', 125, 55, 10);
    $pdf->SetXY(96, 61.5);
    $pdf->SetFont('Arial', 'B', 4);
    ...
    $pdf->Image("mapaqroR.png", 92, 76.5, 10);
    $pdf->Image('secSeg.jpg', 119, 82.5, 15);

    $pdf->Output('I', 'licencia.pdf', true);
?>