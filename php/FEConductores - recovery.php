            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="margin: 10px 0px 0px 10px;">
                        ...
                        <h4 class="text-center" style="color: rgb(122,125,129);">Proceso de bajas</h4>
                    </div>
                </div>
            </div>
        </div>
...
<div class="contenido">
	<form id="form1" name="form1" method="post" action="">
		...
		<p>
			<label>
				<input name="eliminar" type="submit" id="eliminar" value="Eliminar" class="btn btn-primary contenido">
			</label>
		</p>
	</form>
</div>
