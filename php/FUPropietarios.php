...
if (isset($_POST['id'])) {
  ...
  if ($DisplayForm){
    ?>
 <form method="post" action="../php/PUPropietarios.php" enctype="multipart/form-data">
     <div class="row">
         <div class="col"></div>
         <div class="col">
    <label>
      <p>RFC Antiguo:</p>
      <input name="rfcV" type="text" id="rfcV" required="" value=<?php echo $array[0]; ?> />
    </label>
         </div>
         <div class="col">
    <label>
      <p>RFC Nuevo:</p>
      <input name="rfcN" type="text" id="rfcN" required="" value=<?php echo $array[0]; ?> />
    </label>
         </div>
         <div class="col">
    <label>
      <p>CURP:</p>
      <input name="curp" type="text" id="curp" required="" value=<?php echo $array[1]; ?> />
    </label>
         </div>
         <div class="col"></div>
     </div>
    ...
    <label>
      <p>Nombre:</p>
      <input name="nombre" type="text" id="nombre" required="" value=<?php echo $array[2]; ?> />
    </label>
     </div>
         <div class="col">
    <label>
      <p>Dirección:</p>
      <input name="direccion" type="text" id="direccion" required="" value=<?php echo $array[3]; ?> />
    </label>
     </div>
         <div class="col"></div>
     </div>
