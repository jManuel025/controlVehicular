    ...
    <div id="wrapper">
        <div class="flex-grow-0" id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand"> <a class="text-center logo" href="../index1.html"
                        style="color: #8fb8e4;">Sistema de control vehicular</a></li>
        ...
        <div class="page-content-wrapper">
            <div class="container-fluid" style="padding-left: 0px;padding-right: 0px;">
                <div class="d-flex justify-content-between align-items-center up-bar"
                    style="background-color: #6387A6;height: 50px;"><a class="btn btn-link flex-grow-0" role="button"
                        id="menu-toggle" href="#menu-toggle"><i class="fa fa-bars"
                            style="color: #ffffff;font-size: 32px;"></i></a>
                    <div class="dropdown" style="margin-right: 10px;"><button class="btn btn-primary dropdown-toggle"
                            data-toggle="dropdown" aria-expanded="false" type="button"
                            style="background-color: rgba(0,0,0,0);border-color: rgba(0,0,0,0);font-size: 28px;height: 49px;"><i
                                class="fa fa-user"></i></button>
                        <div class="dropdown-menu dropdown-menu-left" role="menu"
                            style="padding-right: 0px;margin-right: 50px;"><a class="dropdown-item" role="presentation"
                                href="#">Ver usuario</a><a class="dropdown-item" role="presentation" href="#">Cerrar
                                sesion</a></div>
                    </div>
                </div>
                <div class="row">
    ...
    ?>
                            ...
                            <div class="col sm-4">
                                <label>
                                    ...
                                    <input name="curp" type="text" id="curp" required=""
                                        placeholder="AAAA000000AAAAAA00" value=<?php echo $array[0];?> 
                                </label> 
                            </div>
                            <div class="col sm-4">              
                            <label>
                                ...
                                <input name="nombre" type="text" id="nombre" required=""
                                    placeholder="Miguel de Cervantes Saavedra" value=<?php echo $array[1];?>
                            </label>
                            </div> 
                            <div class="col sm-4">
                                <label>
                                    ...
                                    <input name="direccion" type="text" id="direccion" required=""
                                        placeholder="Enrique Segoviano, Col. Chespirito #8"
                ...
                <p>No <input name='donador' type='radio' value='No' /></p>
                        ...
                        <div class="row datos-final">
                            <div class="col sm-4">
                                <label>
                                    ...
                                    <label>
                                        ...
                                        <input name="telEmergencia" type="tel" id="telEmergencia" pattern="[0-9]{10}"
                                            placeholder="8743516948" value=<?php echo $array[7];?>
                                        </label> 
                                    </div> 
                                    <div class="col sm-4">
                                        <label>
                            ...
                            <div class="col xs-4" style="margin-left:18%;">
