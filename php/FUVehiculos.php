...
if (isset($_POST['id'])) {
  ...
  if ($DisplayForm){
    ...
    <label>
      <p>Color:</p>
      <input name="color" type="text" id="color" value=<?php echo $array[6]; ?> required/>
    </label>
            </div>
            <div class="col">
    <label>
      <p>Puertas:</p
      <input name="puertas" type="number" id="puertas" value=<?php echo $array[7]; ?> required/>
    </label>
            </div>
            <div class="col">
    <label>
      <p>Marca:</p>
      <input name="marca" type="text" id="marca" required value=<?php echo $array[8]; ?> />
    </label>
            </div>
    <div class="col uso">
      <p>Transmisión:</p>
