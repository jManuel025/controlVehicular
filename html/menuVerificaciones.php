            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="margin: 10px 0px 0px 10px;">
                        <h1 class="text-center">Verificaciones</h1>
                    </div>
                </div>
            </div>
            <div>
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h6 class="text-muted card-subtitle mb-2">Aqui puedes dar de alta nuevas Verificaciones</h6><a class="btn btn-primary active" role="button" style="background-color: #61a8e4;" href="FVerificaciones.php">Dar de alta</a></div>
                </div>
                <div class="card">
                    <div class="card-body text-center">
                        <h2 class="card-title">Bajas</h2><i class="fa fa-minus-circle" style="font-size: 96px;color: #61a8e4;"></i>
                        <h6 class="text-muted card-subtitle mb-2">Aqui puedes dar de baja las Verificaciones</h6><a class="btn btn-primary" role="button" style="background-color: #61a8e4;" href="../PHP/FEVerificaciones.php">Dar de baja</a></div>
                </div>
                <div class="card">
                    <div class="card-body text-center">
                        <h2 class="card-title">Consultas</h2><i class="fa fa-search" style="font-size: 96px;color: #61a8e4;"></i>
                        <h6 class="text-muted card-subtitle mb-2">Aqui puedes hacer una consulta dentro de Verificaciones</h6><a class="btn btn-primary" role="button" style="background-color: #61a8e4;" href="../PHP/FCVerificaciones.php">Hacer Consulta</a></div>
                </div>
            </div>
        </div>
    </div>
