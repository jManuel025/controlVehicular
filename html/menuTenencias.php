            ...
            <div>
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h6 class="text-muted card-subtitle mb-2">Aqui puedes dar de alta nuevas Tenencias</h6><a class="btn btn-primary active" role="button" style="background-color: #61a8e4;" href="FTenencias.php">Dar de alta</a></div>
                </div>
                <div class="card">
                    <div class="card-body text-center">
                        <h2 class="card-title">Bajas</h2><i class="fa fa-minus-circle" style="font-size: 96px;color: #61a8e4;"></i>
                        <h6 class="text-muted card-subtitle mb-2">Aqui puedes dar de baja las Tenencias</h6><a class="btn btn-primary" role="button" style="background-color: #61a8e4;" href="../PHP/FETenencias.php">Dar de baja</a></div>
                </div>
                <div class="card">
                    <div class="card-body text-center">
                        <h2 class="card-title">Cambios</h2><i class="fa fa-exchange" style="font-size: 96px;color: #61a8e4;"></i>
                        <h6 class="text-muted card-subtitle mb-2">Aqui puedes modificar atributos de las Tenencias</h6><a class="btn btn-primary" role="button" style="background-color: #61a8e4;" href="../PHP/FUTenencias.php">Dar de alta</a></div>
                </div>
                <div class="card">
                    <div class="card-body text-center">
                        <h2 class="card-title">Consultas</h2><i class="fa fa-search" style="font-size: 96px;color: #61a8e4;"></i>
                        <h6 class="text-muted card-subtitle mb-2">Aqui puedes hacer una consulta dentro de Tenencias</h6><a class="btn btn-primary" role="button" style="background-color: #61a8e4;" href="../PHP/FCTenencias.php">Dar de alta</a></div>
                </div>
            </div>
        </div>
    </div>
